...
export default function navbar(){
  ...
  setIsMenuOpen(false);
    ...
    return(
        <>
             <nav className="fixed top-0 left-0 h-full w-64 bg-gray-50 shadow-md z-50 hidden lg:block">
          <div className="flex flex-col items-center justify-center w-full py-6">
            <h1 className="text-2xl text-gray-600 font-bold mb-8">Kit Francis Besa</h1>
            <img className="rounded-full items-center justify-center max-w-36" src="/images/nopp.png" alt="Profile-Pic" />
            <div>
              <p className="text-center px-3 text-black pt-2">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-2 w-full text-left rounded-md px-4 py-2 text-lg font-bold transition duration-200
                    ${isActive ? "bg-gray-700 text-white" : "text-gray-600 hover:bg-gray-700 hover:text-white"}`}
                >
        ...
        <nav className="w-full bg-white shadow-md lg:hidden">
  ...
  `}
>
     <div className="flex flex-col bg-white px-4 pb-4 space-y-4">
            <h1 className="text-2xl text-gray-600 font-bold pt-5 flex justify-center">Kit Francis Besa</h1>
